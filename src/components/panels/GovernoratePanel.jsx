...
export default function GovernoratePanel({ governorate, summary, delegations, metric, currentTime, onSelectDelegation }) {
  return (
    <section className="panel-shell">
      ...
      <div className="diagnosis-box">Regional diagnosis: {summary.congested_cells ? 'Congestion is concentrated in the ranked delegations; drill down before simulating cell actions.' : 'No congested cells in the selected time slice.'}</div>
