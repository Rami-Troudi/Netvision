...
export default function RankingTable({ title, rows = [], metricLabel, metricUnit = '', onSelect, empty = 'No rows available.' }) {
  return (
    <div className="ranking-card">
      <div className="section-title">{title}</div>
      {rows.length ? <table><thead><tr><th>#</th><th>Name</th><th>Status</th><th>{metricLabel}</th><th>Cells</th><th>PRB</th></tr></thead><tbody>
